...
export const ToClickTW = {
    ...
    form: "bg-[#B7A692] text-white font-semibold rounded-md p-1 text-center ",
    textSize: "bg-[#776D5C] text-white font-semibold rounded-md",
    choice: "bg-[#776D5C] hover:bg-[#575044] border border-[#575044] text-white font-semibold rounded-md "
        + "my-2 w-[100px] md:[120px] h-[40px] md:h-[30px] ",
    decide: "bg-[#1F2724] hover:bg-[#657261] text-white font-semibold rounded-md "
        + "py-1 px-3 text-center hover:drop-shadow-md ",
    link: "",
    input: "hover:drop-shadow-md shadow appearance-none border"
