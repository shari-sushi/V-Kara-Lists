...
export const TableCss = {
  ...
  // column
  favoriteColumn: "relative flex rounded-full w-10 bg-[#fbd5d2] text-black",
  NeedLoginMessage: "absolute bg-[#B7A692] rounded-2xl right-0 top-0 px-2 w-[140px]",
  deleteColumn: "",
...
export const ToClickTW = {
  regular: "bg-[#776D5C] hover:bg-[#575044] hover:cursor-pointer text-white font-semibold rounded-md p-1",
  formButton: "bg-[#B7A692] text-white font-semibold rounded-md p-1 shadow-sm shadow-black hover:shadow-none",
  textSize: "bg-[#776D5C] text-white font-semibold rounded-md",
  buttonNormal: "bg-[#B7A893] hover:bg-[#776D5C] px-1 h-6 text-white rounded-md shadow-sm shadow-black hover:shadow-none select-none",
  buttonSm: "text-white text-sm rounded-md shadow-sm shadow-black hover:shadow-inner hover:shadow-[#FFF6E4]",
  textSize: "bg-[#776D5C] text-white font-semibold rounded-md",
  choice: "md:hover:bg-[#657261] border border-[#575044] text-white font-semibold " + " w-[100px] md:[120px] h-[40px] md:h-[40px] rounded-md",
  decide: "bg-[#657261] shadow-md hover:bg-[#1F2724] shadow-black hover:shadow-inner hover:shadow-[#FFF6E4] text-white font-semibold rounded-md" + " py-1 px-3 text-center ",
  link: "",
  input: "hover:drop-shadow-md shadow appearance-none border" + " rounded w-full py-2 px-3 text-black leading-tight focus:outline-none focus:shadow-outline bg-gray-300 ",
  multipleInputRow: "hover:drop-shadow-md shadow appearance-none border" + " w-full py-1 px-3 text-black leading-tight focus:outline-none focus:shadow-outline bg-gray-300",
