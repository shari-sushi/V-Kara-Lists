...
const NoticeItems: NoticeItem[] = [
  ...
  {
    data: "2026-05-20",
    title: "動画の登録と表示されない不具合の修正",
    content: "動画にVTuberが紐づかない登録ができることがある不具合および、その動画が一覧に表示されていなかった不具合が修正されました",
  },
  {
    data: "2026-05-20",
    title: "TOPページの歌枠(動画)一覧がスクロール表示に",
    content: "動画数が増えるにつれ、TOPページの歌枠(動画)一覧が縦長になり過ぎていました。縦サイズを固定化し、スクロールできるようにしました。",
  },
  {
    data: "2026-05-19",
