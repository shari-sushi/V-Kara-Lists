...
export function TestLink({ thisPageNum }: { thisPageNum?: number }) {
  return (
    <div>
      <Link href={`/test`} className="float-left bg-green-200 text-[#000000] font-extrabold px-4 min-w-5 rounded-full ">
        test-top
      </Link>
      ...
      <Link href="/test/form-validate" className="float-left bg-green-200 text-[#000000] font-extrabold px-4 min-w-5 rounded-full ">
        form-validate
      </Link>
      <Link href="/test/upload" className="float-left bg-green-200 text-[#000000] font-extrabold px-4 min-w-5 rounded-full ">
        upload-file
      </Link>
    </div>
  )
